 ...
 * @property {string} customer_id - id if the customer
 ...
 * @property {string} confirmation - confirmation of customer
 ...
 * @property {string} reward_update_notification - customer revice reward update notifications
 * @property {string} reward_warning_notification - customer revice reward warning notifications
 * @property {string} rp_token - customers rp_token
 * @property {string} rp_token_created_at - customers rp_token created at
 * @property {string} suffix - suffix of customer
 * @property {string} taxvat - taxvat of customer
