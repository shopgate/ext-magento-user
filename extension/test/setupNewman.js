...
const envTemplate = JSON.parse(fs.readFileSync(path.join(__dirname, 'newman', 'environment.json.template')))
...
fs.writeFileSync(path.join(__dirname, 'newman', 'environment.json'), JSON.stringify(envTemplate, null, 2))
console.log('done')
